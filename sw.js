const CACHE_NAME='ordini-hd-accademia-v15';
const FILES=['./style.css?v=15','./v4.css?v=15','./app.js?v=15','./danea_patch.js?v=15','./prodotti.json?v=15','./app.webmanifest?v=15','./icon.svg'];
...
self.addEventListener('fetch',e=>{
  ...
  if(e.request.mode==='navigate'){
    e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match('./index.html?v=15')));
    return;
  }
