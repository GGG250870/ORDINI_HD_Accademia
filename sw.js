const CACHE_NAME='ordini-hd-accademia-v14';
const FILES=['./style.css?v=14','./v4.css?v=14','./app.js?v=14','./danea_patch.js?v=14','./prodotti.json?v=14','./app.webmanifest?v=14','./icon.svg'];
...
self.addEventListener('fetch',e=>{
  ...
  if(e.request.mode==='navigate'){
    e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match('./index.html?v=14')));
    return;
  }
